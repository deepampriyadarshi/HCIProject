...
prev_time = 0
mob_cam = 'http://192.168.1.9:4747/video'
lap_cam = 1
        ...
        for idx, classificaion in enumerate(results.multi_handedness):
            if classificaion.classification[0].label == "Left":            
                ...
                if(distance(itx, ity, thtx, thty) < 10 and abs(prev_off_time - current_time) > 4):
                    ...
                    print("Next Channel")
                    cv2.putText(image, 'Next Channel', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                    ...
                    print("Prev Channel")
                    cv2.putText(image, 'Prev Channel', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                    ...
                    cv2.putText(image, 'Mute', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                ...
                if(distance(itx, ity, thtx, thty) < 10 ):
                    print("Volume Up")
                    cv2.putText(image, 'Volume Up', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                    curr.execute("INSERT INTO movement (direction, time) VALUES ('vol_up', NOW())")
                    db.commit()
                    prev_off_time = current_time
                elif(distance(mtx, mty, thtx, thty) < 15 ):
                    print("Volume Down")
                    cv2.putText(image, 'Volume Down', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
